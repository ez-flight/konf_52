...
plt.axhline(theta_min, color='b', linestyle='-.', label=f'θ_min = {theta_min:.1f}°')
plt.axhline(theta_max, color='b', linestyle='--', label=f'θ_max = {theta_max:.1f}°')
...
plt.ylabel('Угол визирования, θ (°)', fontsize=12)
